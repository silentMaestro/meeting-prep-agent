...
export default function SettingsPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a]">
      {/* Header */}
      <header className="bg-[#0f0f0f] border-b border-white/6 px-4 py-4 flex items-center gap-2 safe-top">
        <button
          onClick={() => router.push("/")}
          className="flex items-center gap-1.5 -ml-1 px-2 py-1.5 rounded-lg hover:bg-white/6 text-zinc-500 hover:text-zinc-300 transition-colors"
        >
